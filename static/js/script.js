...
// Upload Image
const photoInput = document.querySelector("#id_avatar");
const photoPreview = document.querySelector("#haha1");
if (photoInput)
  photoInput.onchange = () => {
...
// Upload Thumbnail
const TInput = document.querySelector("#id_thumbnail");
const TPreview = document.querySelector('#haha2');
if (TInput)
  TInput.onchange = () => {
    const [file] = TInput.files;
    if (file) {
      TPreview.src = URL.createObjectURL(file);
    }
  };
...
// Append text
// const abc = setTimeout(haha, 2000);
// function haha() {
//   $('div[name="1a1"]').append("<p>hahaha</p>")
// }